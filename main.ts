...
const guesses: number[] = [5, 15, 11, 7, 3, 19, 17,  1, 6, 4, 20];
...
while (!guessStatus && i < guesses.length) {
  ...
  if (guess === randomNumber) {
    console.log(`Congratulations! Your guess of ${guess} is correct!`);
    guessStatus = true;
  } else if (guess < randomNumber) {
    console.log(`Sorry, your guess of ${guess} is too low.`);
  } else {
    console.log(`Sorry, your guess of ${guess} is too high.`);
  }
...
if (!guessStatus) {
  console.log(`The correct answer was ${randomNumber}, None of the gusses were correct`);
}
