...
var guesses = [5, 15, 11, 7, 3, 19, 17, 1, 6, 4, 20];
var i = 0;
while (!guessStatus && i < guesses.length) {
    var guess = guesses[i];
    if (guess === randomNumber) {
        console.log("Congratulations! Your guess of ".concat(guess, " is correct!"));
        guessStatus = true;
    }
    else if (guess < randomNumber) {
        console.log("Sorry, your guess of ".concat(guess, " is too low."));
    }
    else {
        console.log("Sorry, your guess of ".concat(guess, " is too high."));
    }
    i++;
}
if (!guessStatus) {
    console.log("The correct answer was ".concat(randomNumber, ", None of the gusses were correct"));
}
